              ...
              {admins.map((a) => (
                <tr key={a.id} className="hover:bg-gray-50">
                  ...
                  <td className="p-4 flex gap-2">
                    ...
                    <button onClick={() => canReset && setResetPwdTarget({id: a.id, name: a.firstName})}
                      disabled={!canReset}
                      className={`text-sm px-2 py-1 rounded ${canReset ? 'bg-purple-50 text-purple-700 hover:bg-purple-100' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}`}>
                      🔑 MDP
                    </button>
                  </td>
                </tr>
