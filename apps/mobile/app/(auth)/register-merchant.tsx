...
const styles = StyleSheet.create({
  ...
  progressContainer: { backgroundColor: Colors.surface, paddingHorizontal: 20, paddingTop: 52, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: Colors.border },
  backBtn: { marginBottom: 10 },
  backArrow: { fontSize: 18, color: Colors.textPrimary },
  stepsRow: { flexDirection: 'row', gap: 8, alignItems: 'center', marginBottom: 6 },
  stepDot: { width: 30, height: 30, borderRadius: 15, borderWidth: 2, borderColor: Colors.border, justifyContent: 'center', alignItems: 'center', backgroundColor: Colors.bg },
  ...
  input: { backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, borderRadius: Radius.md, paddingHorizontal: 16, paddingVertical: 13, fontSize: 15, color: Colors.textPrimary },
  ...
  gpsBtn: { backgroundColor: Colors.primaryLight, borderWidth: 1.5, borderColor: Colors.primary, borderRadius: Radius.md, paddingVertical: 14, alignItems: 'center', marginBottom: 8 },
