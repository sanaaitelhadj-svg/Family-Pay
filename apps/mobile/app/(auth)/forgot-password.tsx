...
const s = StyleSheet.create({
  ...
  card:            { backgroundColor: Colors.surface, borderRadius: Radius.xl, padding: 22, borderWidth: 1, borderColor: Colors.border, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
  ...
  input:           { borderWidth: 1, borderColor: Colors.border, borderRadius: Radius.md, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, backgroundColor: Colors.surface, color: Colors.textPrimary },
