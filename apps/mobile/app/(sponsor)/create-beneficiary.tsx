...
export default function CreateBeneficiaryScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (status === 409) {
        // Doublon téléphone ou email
        if (msg.toLowerCase().includes('phone') || msg.toLowerCase().includes('téléphone') || msg.toLowerCase().includes('telephone')) {
      ...
      console.log('[CREATE-BENEF ERROR]', status, msg);
    } finally {
      setLoading(false);
    }
  };
        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.field}>
            ...
            {Platform.OS === 'web' ? (
              ...
              <TextInput
                style={[styles.input, errors.dateOfBirth && styles.inputErr]}
