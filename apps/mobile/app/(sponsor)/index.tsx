...
export default function SponsorAllocationsScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Mes allocations</Text>
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>Aucune allocation créée</Text>}
      />
    </View>
  );
}
