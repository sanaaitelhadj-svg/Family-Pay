...
const styles = StyleSheet.create({
  ...
  thresholdToggleCard: { backgroundColor: '#F9FAFB', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: '#E5E7EB' },
  thresholdToggleTop:  { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  thresholdBox:      { backgroundColor: '#F9FAFB', borderRadius: 14, padding: 14, marginTop: 4, gap: 4, borderWidth: 1, borderColor: '#E5E7EB' },
