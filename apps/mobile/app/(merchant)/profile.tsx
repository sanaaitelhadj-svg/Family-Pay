...
const styles = StyleSheet.create({
  ...
  hero: { alignItems: 'center', paddingTop: 64, paddingBottom: 28, backgroundColor: Colors.primary, shadowColor: Colors.primary, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.25, shadowRadius: 16, elevation: 6 },
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(255,255,255,0.18)', justifyContent: 'center', alignItems: 'center', marginBottom: 12, borderWidth: 2, borderColor: 'rgba(255,255,255,0.3)' },
  avatarText: { color: '#fff', fontWeight: '800', fontSize: 30 },
  name: { color: '#fff', fontSize: 22, fontWeight: '800', letterSpacing: -0.3 },
  sub: { color: 'rgba(255,255,255,0.7)', fontSize: 13, marginTop: 3 },
  ...
  statCard: { flex: 1, backgroundColor: Colors.surface, borderRadius: Radius.lg, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: Colors.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 1 },
  statNum: { fontSize: 20, fontWeight: '800', color: Colors.primary, letterSpacing: -0.3 },
  ...
  editBtn: { marginHorizontal: 16, marginBottom: 10, backgroundColor: Colors.primary, borderRadius: 14, paddingVertical: 16, alignItems: 'center', shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 12, elevation: 4 },
  editBtnDisabled: { backgroundColor: '#9CA3AF' },
  editBtnText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  logoutBtn: { marginHorizontal: 16, marginTop: 4, backgroundColor: Colors.errorBg, borderRadius: Radius.md, paddingVertical: 15, alignItems: 'center', borderWidth: 1, borderColor: Colors.errorBorder },
