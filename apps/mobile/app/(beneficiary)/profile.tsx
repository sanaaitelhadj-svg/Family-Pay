...
const styles = StyleSheet.create({
  ...
  hero: { alignItems: 'center', paddingTop: 60, paddingBottom: 24, backgroundColor: '#22C55E' },
  ...
  statCardMiddle: { borderColor: '#22C55E', borderWidth: 1.5 },
  statNum: { fontSize: 16, fontWeight: '800', color: '#22C55E' },
