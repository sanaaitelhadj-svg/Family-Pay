...
const styles = StyleSheet.create({
  ...
  title:          { fontSize: 22, fontWeight: '800', color: Colors.textPrimary, marginBottom: 16, marginTop: 52, letterSpacing: -0.3 },
  ...
  manualSection:  { backgroundColor: Colors.surface, borderRadius: Radius.lg, padding: 22, borderWidth: 1, borderColor: Colors.border, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
  ...
  modal:          { backgroundColor: Colors.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 24, gap: 14 },
  ...
  confirmBtn:     { flex: 1, backgroundColor: Colors.primary, borderRadius: 14, paddingVertical: 15, alignItems: 'center', shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 4 },
